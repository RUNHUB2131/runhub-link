...
export const RunClubSettingsView = ({ profile }: RunClubSettingsViewProps) => {
  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      // Delete user-specific data but preserve applications and related data
      // This allows brands to still see historical applications
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="text-left">
                <p className="font-semibold text-base">
                  {profile.club_name || "Your Run Club"}
                </p>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              All your data, including your run club profile and personal information will be permanently removed.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
